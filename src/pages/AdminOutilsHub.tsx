...
const OUTILS = [
  ...
  {
    titre: 'Moteur de recherche du site',
    description: 'Le catalogue des pages publiques et les règles qui les classent dans les cinq univers (Jardin, Vignoble, Marches, Éco tourisme, Vivant).',
    icon: Search,
    to: '/admin/outils/recherche',
    active: true,
  },
