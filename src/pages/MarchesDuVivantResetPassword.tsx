...
const MarchesDuVivantResetPassword: React.FC = () => {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Définissez votre nouveau mot de passe pour rejoindre les Marches du Vivant
          </CardDescription>
        </CardHeader>
...
export default MarchesDuVivantResetPassword;
