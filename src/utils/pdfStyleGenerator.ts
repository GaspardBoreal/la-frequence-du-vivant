...
const FONT_URLS: Record<string, { regular: string; bold?: string; italic?: string; boldItalic?: string }> = {
  ...
  // IMPORTANT: Using latin-ext subset to support extended characters (ū, ō, ā, ī, etc.)
  Georgia: {
    regular: `${FONTSOURCE_CDN}/lora@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/lora@latest/latin-ext-700-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/lora@latest/latin-ext-400-italic.ttf`,
    boldItalic: `${FONTSOURCE_CDN}/lora@latest/latin-ext-700-italic.ttf`,
  },
  'Playfair Display': {
    regular: `${FONTSOURCE_CDN}/playfair-display@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/playfair-display@latest/latin-ext-700-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/playfair-display@latest/latin-ext-400-italic.ttf`,
    boldItalic: `${FONTSOURCE_CDN}/playfair-display@latest/latin-ext-700-italic.ttf`,
  },
  'Cormorant Garamond': {
    regular: `${FONTSOURCE_CDN}/cormorant-garamond@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/cormorant-garamond@latest/latin-ext-700-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/cormorant-garamond@latest/latin-ext-400-italic.ttf`,
    boldItalic: `${FONTSOURCE_CDN}/cormorant-garamond@latest/latin-ext-700-italic.ttf`,
  },
  Lora: {
    regular: `${FONTSOURCE_CDN}/lora@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/lora@latest/latin-ext-700-normal.ttf`,
  ...
  'EB Garamond': {
    regular: `${FONTSOURCE_CDN}/eb-garamond@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/eb-garamond@latest/latin-ext-700-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/eb-garamond@latest/latin-ext-400-italic.ttf`,
    boldItalic: `${FONTSOURCE_CDN}/eb-garamond@latest/latin-ext-700-italic.ttf`,
  },
  'Crimson Pro': {
    regular: `${FONTSOURCE_CDN}/crimson-pro@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/crimson-pro@latest/latin-ext-700-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/crimson-pro@latest/latin-ext-400-italic.ttf`,
    boldItalic: `${FONTSOURCE_CDN}/crimson-pro@latest/latin-ext-700-italic.ttf`,
  },
  'Libre Baskerville': {
    regular: `${FONTSOURCE_CDN}/libre-baskerville@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/libre-baskerville@latest/latin-ext-700-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/libre-baskerville@latest/latin-ext-400-italic.ttf`,
  },
  'DM Serif Display': {
    regular: `${FONTSOURCE_CDN}/dm-serif-display@latest/latin-ext-400-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/dm-serif-display@latest/latin-ext-400-italic.ttf`,
  },
  Fraunces: {
    regular: `${FONTSOURCE_CDN}/fraunces@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/fraunces@latest/latin-ext-700-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/fraunces@latest/latin-ext-400-italic.ttf`,
    boldItalic: `${FONTSOURCE_CDN}/fraunces@latest/latin-ext-700-italic.ttf`,
  },
  Merriweather: {
    regular: `${FONTSOURCE_CDN}/merriweather@latest/latin-ext-400-normal.ttf`,
    bold: `${FONTSOURCE_CDN}/merriweather@latest/latin-ext-700-normal.ttf`,
    italic: `${FONTSOURCE_CDN}/merriweather@latest/latin-ext-400-italic.ttf`,
    boldItalic: `${FONTSOURCE_CDN}/merriweather@latest/latin-ext-700-italic.ttf`,
  },
};
