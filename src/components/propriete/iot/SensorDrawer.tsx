...
import { sensorHealth, HEALTH_COLOR, fmtHorodatage, grandeurMeta, fmtProfondeur, moistureVerdict, compareGrandeurs, withExpectedSlots } from '@/lib/iot/grandeurs';
    ...
    <Sheet open={!!capteur} onOpenChange={(o) => !o && onClose()}>
      ...
      >
        ...
        <div className="mt-2 grid gap-2 sm:grid-cols-2">
          ...
          {withExpectedSlots(latest as any[], (capteur as any).type?.profondeurs_m, (capteur as any).type?.grandeurs).map((m: any, i) =>
            m.missing ? (
              <div
