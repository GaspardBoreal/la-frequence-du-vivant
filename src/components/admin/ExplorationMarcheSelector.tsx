        ...
        <div className="flex gap-4 items-center mb-8">
          <div className="relative flex-1 group">
            ...
            <Input
              ...
              className="pl-12 pr-4 py-3 bg-gaspard-background/30 backdrop-blur-sm border-gaspard-accent/30 rounded-2xl focus:border-gaspard-accent/50 transition-all duration-500 hover:bg-gaspard-background/50 focus:bg-gaspard-background/60 text-gaspard-background placeholder:text-gaspard-muted/80"
            />
