        ...
        {allTypes.map((type) => {
          ...
          return (
            <DropdownMenuItem
              ...
              className={`flex items-center gap-2 cursor-pointer hover:bg-muted/50 hover:text-emerald-900 dark:hover:text-emerald-900 data-[highlighted]:text-emerald-900 dark:data-[highlighted]:text-emerald-900 ${
                isActive 
