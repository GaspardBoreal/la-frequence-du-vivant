            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3">
                {regionalData?.slice(0, 4).map((region, index) => (
                  <motion.div
                    key={region.region}
                    className="p-3 rounded-lg bg-gradient-to-br from-green-900/90 to-emerald-900/90 border border-green-700 hover:border-green-500/60 transition-all duration-200 hover:shadow-md hover:shadow-green-500/10 min-h-[120px] flex flex-col justify-between"
                    initial={{ opacity: 0, scale: 0.95 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ delay: index * 0.1 }}
                  >
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-medium text-xs text-white truncate max-w-[80px]">
                        {region.region}
                      </h4>
                      <Badge variant="outline" className="text-xs bg-green-800/60 text-green-200 border-green-600 px-1 py-0">
                        {region.marches}
                      </Badge>
                    </div>
                    <div className="space-y-1.5 flex-1">
                      ...
                      <div className="flex justify-between text-xs">
                        <span className="text-gray-300">Densité/marche</span>
                        <span className="font-medium text-green-300">
