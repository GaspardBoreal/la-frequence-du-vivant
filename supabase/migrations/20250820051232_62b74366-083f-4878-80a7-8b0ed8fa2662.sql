-- Create a function to initialize the first admin by directly creating the user in auth.users
-- This bypasses the email confirmation requirement for the initial setup
